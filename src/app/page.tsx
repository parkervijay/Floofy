      ...
      <section className="app-preview">
        <div className="container">
          ...
          <div className="store-buttons">
            ...
            <a href="#" className="store-btn">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66M4,4.72L11.5,12.22L4,19.72V4.72M13,12.97L16.92,16.89L7.03,21.34L13,12.97M18.21,15.6L13.83,11.22L18.21,6.84C19.36,8.1 20,9.53 20,11C20,12.47 19.36,13.9 18.21,15.16V15.6Z" />
              </svg>
              <div className="store-btn-text">
